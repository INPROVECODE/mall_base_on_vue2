...
export default {
  ...
  computed: {
    ...
    totalPrice() {
      let sum = 0;
      //reduce方法计算
      // sum=this.cartInfoList.reduce(function(prev,cur){
      //   console.log(prev.skuNum*prev.skuPrice)
      //   console.log(cur.skuNum*cur.skuPrice)
      //   return  parseInt(prev.skuNum*prev.skuPrice)+parseInt(cur.skuNum*cur.skuPrice)
      // })
